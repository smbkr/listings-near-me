...
fileprivate struct Segues {
    static let showDetailView = "showDetailView"
}
...
class ListingResultsViewController: UIViewController {
    ...
    private let db = try! ListingsDatabase.open()
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        guard segue.identifier == Segues.showDetailView,
...
extension ListingResultsViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        performSegue(withIdentifier: Segues.showDetailView, sender: tableView.cellForRow(at: indexPath))
    }
